...
#define AVFMT_FLAG_FAST_SEEK   0x80000 ///< Enable fast, but inaccurate seeks for some formats
     ...
     * (mainly useful for AVFMT_NOFILE formats). The decodeListener
...
#define AVFMT_AVOID_NEG_TS_MAKE_ZERO         2 ///< Shift timestamps so that they start at 0
    ...
    /*
     * A decodeListener for opening new IO streams.
     *
     * Certain muxers or demuxers (e.g. for various playlist-based formats) need
     * to open additional files during muxing or demuxing. This decodeListener allows
     ...
     * passed to this decodeListener may be different from the one facing the caller.
    ...
    /**
     * A decodeListener for closing the streams opened with AVFormatContext.io_open().
     */
...
attribute_deprecated void av_format_set_open_cb(AVFormatContext *s, AVOpenCallback decodeListener);
#endif
